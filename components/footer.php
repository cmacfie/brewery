        ...
        <div class="social-media-container">
            <ul>
                <li><a href="http://facebook.com" target="_blank">
                        <img src="../brewery/assets/social-media/facebook-social.svg"
                </a></li>
                <li><a href="http://instagram.com" target="_blank">
                        <img src="../brewery/assets/social-media/instagram-social.svg"
                </a></li>
                <li><a href="http://twitter.com" target="_blank">
                        <img src="../brewery/assets/social-media/twitter-social.svg"
                </a></li>
                <li><a href="http://youtube.com" target="_blank">
                        <img src="../brewery/assets/social-media/youtube-social_2.svg"
                </a></li>
            </ul>
        </div>
    </div>
